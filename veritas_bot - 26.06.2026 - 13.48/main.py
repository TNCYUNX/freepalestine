...
def callback_yonetici(call):
    ...
    MODULER_PREFIXES = ('menu_bakiye_yukle', 'yukle_sec_', 'checkpay_', 'qr_show_', 'admin_', 'paynet_', 'menu_numara_al', 'menu_populer', 'select_srv_', 'select_tier_', 'buy_num_', 'rebuy_', 'cancel_sms_', 'check_sms_')
