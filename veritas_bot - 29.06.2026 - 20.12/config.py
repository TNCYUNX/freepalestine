...
MESAJLAR = {
    "hosgeldin": (
        "🎉 *Veritas SMS Sistemine Hoş Geldiniz!*\n\n"
        "📱 WhatsApp, Telegram, Google ve tüm popüler platformlar\n"
        "💰 TRX / USDT ile %100 otomatik bakiye yükleme\n"
        "⚡ Anlık, şifreli ve güvenli SMS teslimatı\n\n"
        "🆘 *Destek:* @nilayoff\n\n"
        "👇 Lütfen işlem yapmak istediğiniz menüyü seçin:"
    ),
...
ISLEM_TIPLERI = {
    1: "Kripto Otomatik Yükleme",
    2: "Başarılı Numara Alımı",
    3: "Zaman Aşımı İptali (20 Dk)",
    4: "Kullanıcı İptali",
    5: "Admin Panel Manuel Bakiye Ekleme",
    6: "Kupon Kullanımı"
}
